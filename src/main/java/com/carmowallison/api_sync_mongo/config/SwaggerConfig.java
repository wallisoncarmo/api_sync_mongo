...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.basePackage("com.carmowallison.api_sync_mongo.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API Sync Mongo",
				"Sincroniza os dados do mongo com os do storage do ionic.", "Versão 1.0",
				"https://github.com/wallisoncarmo/api_sync_mongo",
				new Contact("Wallison do Carmo Costa", "https://github.com/wallisoncarmo/api_sync_mongo", "wallisoncarmo01@gmail.com"),
				null, 
